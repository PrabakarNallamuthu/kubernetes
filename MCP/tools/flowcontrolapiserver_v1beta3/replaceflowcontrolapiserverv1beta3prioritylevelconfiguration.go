...
func Replaceflowcontrolapiserverv1beta3prioritylevelconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceflowcontrolapiserverv1beta3prioritylevelconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_flowcontrol.apiserver.k8s.io_v1beta3_prioritylevelconfigurations_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceflowcontrolapiserverv1beta3prioritylevelconfigurationHandler(cfg),
	}
}
