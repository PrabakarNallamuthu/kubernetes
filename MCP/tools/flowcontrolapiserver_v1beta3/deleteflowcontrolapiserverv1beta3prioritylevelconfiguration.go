...
func Deleteflowcontrolapiserverv1beta3prioritylevelconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteflowcontrolapiserverv1beta3prioritylevelconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_flowcontrol.apiserver.k8s.io_v1beta3_prioritylevelconfigurations_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteflowcontrolapiserverv1beta3prioritylevelconfigurationHandler(cfg),
	}
}
