...
func Listflowcontrolapiserverv1beta3flowschemaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListflowcontrolapiserverv1beta3flowschemaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_flowcontrol.apiserver.k8s.io_v1beta3_flowschemas",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listflowcontrolapiserverv1beta3flowschemaHandler(cfg),
	}
}
