...
func Deleteflowcontrolapiserverv1beta3collectionprioritylevelconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/flowcontrol.apiserver.k8s.io/v1beta3/prioritylevelconfigurations%s", cfg.BaseURL, queryString)
...
func CreateDeleteflowcontrolapiserverv1beta3collectionprioritylevelconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_flowcontrol.apiserver.k8s.io_v1beta3_prioritylevelconfigurations",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteflowcontrolapiserverv1beta3collectionprioritylevelconfigurationHandler(cfg),
	}
}
