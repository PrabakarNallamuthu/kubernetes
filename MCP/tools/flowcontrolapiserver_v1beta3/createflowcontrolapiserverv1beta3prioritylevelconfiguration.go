...
func Createflowcontrolapiserverv1beta3prioritylevelconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateflowcontrolapiserverv1beta3prioritylevelconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_flowcontrol.apiserver.k8s.io_v1beta3_prioritylevelconfigurations",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createflowcontrolapiserverv1beta3prioritylevelconfigurationHandler(cfg),
	}
}
