...
func Replacebatchv1namespacedcronjobstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacebatchv1namespacedcronjobstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_batch_v1_namespaces_namespace_cronjobs_name_status",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacebatchv1namespacedcronjobstatusHandler(cfg),
	}
}
