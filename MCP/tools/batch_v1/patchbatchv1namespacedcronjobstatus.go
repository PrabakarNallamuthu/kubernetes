...
func Patchbatchv1namespacedcronjobstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchbatchv1namespacedcronjobstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_batch_v1_namespaces_namespace_cronjobs_name_status",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Patchbatchv1namespacedcronjobstatusHandler(cfg),
	}
}
