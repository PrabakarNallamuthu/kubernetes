...
func Deleteadmissionregistrationv1alpha1validatingadmissionpolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteadmissionregistrationv1alpha1validatingadmissionpolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration.k8s.io_v1alpha1_validatingadmissionpolicies_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteadmissionregistrationv1alpha1validatingadmissionpolicyHandler(cfg),
	}
}
