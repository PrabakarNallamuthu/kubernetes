...
func Deleteadmissionregistrationv1alpha1collectionvalidatingadmissionpolicybindingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/admissionregistration.k8s.io/v1alpha1/validatingadmissionpolicybindings%s", cfg.BaseURL, queryString)
...
func CreateDeleteadmissionregistrationv1alpha1collectionvalidatingadmissionpolicybindingTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_admissionregistration.k8s.io_v1alpha1_validatingadmissionpolicybindings",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteadmissionregistrationv1alpha1collectionvalidatingadmissionpolicybindingHandler(cfg),
	}
}
