...
func Createflowcontrolapiserverv1beta2flowschemaHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateflowcontrolapiserverv1beta2flowschemaTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_flowcontrol.apiserver.k8s.io_v1beta2_flowschemas",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createflowcontrolapiserverv1beta2flowschemaHandler(cfg),
	}
}
