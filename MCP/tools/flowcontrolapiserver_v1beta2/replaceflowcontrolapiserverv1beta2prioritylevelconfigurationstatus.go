...
func Replaceflowcontrolapiserverv1beta2prioritylevelconfigurationstatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceflowcontrolapiserverv1beta2prioritylevelconfigurationstatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_flowcontrol.apiserver.k8s.io_v1beta2_prioritylevelconfigurations_name_status",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceflowcontrolapiserverv1beta2prioritylevelconfigurationstatusHandler(cfg),
	}
}
