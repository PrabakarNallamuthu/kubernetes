...
func Patchcertificatesv1certificatesigningrequeststatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchcertificatesv1certificatesigningrequeststatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_certificates.k8s.io_v1_certificatesigningrequests_name_status",
		mcp.WithDescription("partially update status of the specified CertificateSigningRequest"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Patchcertificatesv1certificatesigningrequeststatusHandler(cfg),
	}
}
