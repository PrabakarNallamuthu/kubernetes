...
func Replacenetworkingv1namespacednetworkpolicystatusHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenetworkingv1namespacednetworkpolicystatusTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_networking.k8s.io_v1_namespaces_namespace_networkpolicies_name_status",
		mcp.WithDescription("replace status of the specified NetworkPolicy"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacenetworkingv1namespacednetworkpolicystatusHandler(cfg),
	}
}
