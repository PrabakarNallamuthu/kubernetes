...
func Listpolicyv1namespacedpoddisruptionbudgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListpolicyv1namespacedpoddisruptionbudgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_policy_v1_namespaces_namespace_poddisruptionbudgets",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listpolicyv1namespacedpoddisruptionbudgetHandler(cfg),
	}
}
