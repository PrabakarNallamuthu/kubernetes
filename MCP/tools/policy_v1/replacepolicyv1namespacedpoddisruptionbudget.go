...
func Replacepolicyv1namespacedpoddisruptionbudgetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacepolicyv1namespacedpoddisruptionbudgetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_policy_v1_namespaces_namespace_poddisruptionbudgets_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacepolicyv1namespacedpoddisruptionbudgetHandler(cfg),
	}
}
