...
func Patchnodev1runtimeclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchnodev1runtimeclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_node.k8s.io_v1_runtimeclasses_name",
		mcp.WithDescription("partially update the specified RuntimeClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Patchnodev1runtimeclassHandler(cfg),
	}
}
