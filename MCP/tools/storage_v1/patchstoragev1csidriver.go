...
func Patchstoragev1csidriverHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchstoragev1csidriverTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_storage.k8s.io_v1_csidrivers_name",
		mcp.WithDescription("partially update the specified CSIDriver"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Patchstoragev1csidriverHandler(cfg),
	}
}
