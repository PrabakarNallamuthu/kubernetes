...
func Patchstoragev1csinodeHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchstoragev1csinodeTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_storage.k8s.io_v1_csinodes_name",
		mcp.WithDescription("partially update the specified CSINode"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Patchstoragev1csinodeHandler(cfg),
	}
}
