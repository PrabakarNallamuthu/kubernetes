...
func Createresourcev1alpha2namespacedpodschedulingcontextHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateresourcev1alpha2namespacedpodschedulingcontextTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_resource.k8s.io_v1alpha2_namespaces_namespace_podschedulingcontexts",
		mcp.WithDescription("create a PodSchedulingContext"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createresourcev1alpha2namespacedpodschedulingcontextHandler(cfg),
	}
}
