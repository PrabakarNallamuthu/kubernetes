...
func Replaceresourcev1alpha2namespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceresourcev1alpha2namespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource.k8s.io_v1alpha2_namespaces_namespace_resourceclaimtemplates_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1alpha2namespacedresourceclaimtemplateHandler(cfg),
	}
}
