...
func Createresourcev1alpha2resourceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreateresourcev1alpha2resourceclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_resource.k8s.io_v1alpha2_resourceclasses",
		mcp.WithDescription("create a ResourceClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createresourcev1alpha2resourceclassHandler(cfg),
	}
}
