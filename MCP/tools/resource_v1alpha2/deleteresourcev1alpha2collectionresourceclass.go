...
func Deleteresourcev1alpha2collectionresourceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/resource.k8s.io/v1alpha2/resourceclasses%s", cfg.BaseURL, queryString)
...
func CreateDeleteresourcev1alpha2collectionresourceclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource.k8s.io_v1alpha2_resourceclasses",
		mcp.WithDescription("delete collection of ResourceClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteresourcev1alpha2collectionresourceclassHandler(cfg),
	}
}
