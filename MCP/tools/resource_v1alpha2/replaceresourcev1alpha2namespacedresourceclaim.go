...
func Replaceresourcev1alpha2namespacedresourceclaimHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceresourcev1alpha2namespacedresourceclaimTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource.k8s.io_v1alpha2_namespaces_namespace_resourceclaims_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1alpha2namespacedresourceclaimHandler(cfg),
	}
}
