...
func Listresourcev1alpha2resourceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListresourcev1alpha2resourceclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_resource.k8s.io_v1alpha2_resourceclasses",
		mcp.WithDescription("list or watch objects of kind ResourceClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listresourcev1alpha2resourceclassHandler(cfg),
	}
}
