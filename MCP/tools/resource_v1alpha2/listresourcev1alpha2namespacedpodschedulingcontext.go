...
func Listresourcev1alpha2namespacedpodschedulingcontextHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListresourcev1alpha2namespacedpodschedulingcontextTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_resource.k8s.io_v1alpha2_namespaces_namespace_podschedulingcontexts",
		mcp.WithDescription("list or watch objects of kind PodSchedulingContext"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listresourcev1alpha2namespacedpodschedulingcontextHandler(cfg),
	}
}
