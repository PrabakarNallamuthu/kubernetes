...
func Deleteresourcev1alpha2resourceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteresourcev1alpha2resourceclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource.k8s.io_v1alpha2_resourceclasses_name",
		mcp.WithDescription("delete a ResourceClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteresourcev1alpha2resourceclassHandler(cfg),
	}
}
