...
func Replaceresourcev1alpha2resourceclassHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplaceresourcev1alpha2resourceclassTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_resource.k8s.io_v1alpha2_resourceclasses_name",
		mcp.WithDescription("replace the specified ResourceClass"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replaceresourcev1alpha2resourceclassHandler(cfg),
	}
}
