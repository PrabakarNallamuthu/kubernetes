...
func Deleteresourcev1alpha2namespacedpodschedulingcontextHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteresourcev1alpha2namespacedpodschedulingcontextTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource.k8s.io_v1alpha2_namespaces_namespace_podschedulingcontexts_name",
		mcp.WithDescription("delete a PodSchedulingContext"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteresourcev1alpha2namespacedpodschedulingcontextHandler(cfg),
	}
}
