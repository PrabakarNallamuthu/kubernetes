...
func Deleteresourcev1alpha2collectionnamespacedresourceclaimtemplateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/resource.k8s.io/v1alpha2/namespaces/%s/resourceclaimtemplates%s", cfg.BaseURL, queryString)
...
func CreateDeleteresourcev1alpha2collectionnamespacedresourceclaimtemplateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_resource.k8s.io_v1alpha2_namespaces_namespace_resourceclaimtemplates",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deleteresourcev1alpha2collectionnamespacedresourceclaimtemplateHandler(cfg),
	}
}
