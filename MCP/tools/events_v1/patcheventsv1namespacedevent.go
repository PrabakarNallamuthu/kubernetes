...
func Patcheventsv1namespacedeventHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatcheventsv1namespacedeventTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_events.k8s.io_v1_namespaces_namespace_events_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Patcheventsv1namespacedeventHandler(cfg),
	}
}
