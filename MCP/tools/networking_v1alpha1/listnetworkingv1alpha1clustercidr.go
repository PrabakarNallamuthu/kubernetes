...
func Listnetworkingv1alpha1clustercidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListnetworkingv1alpha1clustercidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_networking.k8s.io_v1alpha1_clustercidrs",
		mcp.WithDescription("list or watch objects of kind ClusterCIDR"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listnetworkingv1alpha1clustercidrHandler(cfg),
	}
}
