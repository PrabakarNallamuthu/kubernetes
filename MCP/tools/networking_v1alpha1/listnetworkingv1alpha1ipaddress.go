...
func Listnetworkingv1alpha1ipaddressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateListnetworkingv1alpha1ipaddressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apis_networking.k8s.io_v1alpha1_ipaddresses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Listnetworkingv1alpha1ipaddressHandler(cfg),
	}
}
