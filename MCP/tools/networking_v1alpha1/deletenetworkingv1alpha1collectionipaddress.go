...
func Deletenetworkingv1alpha1collectionipaddressHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/networking.k8s.io/v1alpha1/ipaddresses%s", cfg.BaseURL, queryString)
...
func CreateDeletenetworkingv1alpha1collectionipaddressTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_networking.k8s.io_v1alpha1_ipaddresses",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletenetworkingv1alpha1collectionipaddressHandler(cfg),
	}
}
