...
func Replacenetworkingv1alpha1clustercidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateReplacenetworkingv1alpha1clustercidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_apis_networking.k8s.io_v1alpha1_clustercidrs_name",
		mcp.WithDescription("replace the specified ClusterCIDR"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Replacenetworkingv1alpha1clustercidrHandler(cfg),
	}
}
