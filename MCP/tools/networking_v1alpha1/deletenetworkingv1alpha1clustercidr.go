...
func Deletenetworkingv1alpha1clustercidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeletenetworkingv1alpha1clustercidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_networking.k8s.io_v1alpha1_clustercidrs_name",
		mcp.WithDescription("delete a ClusterCIDR"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletenetworkingv1alpha1clustercidrHandler(cfg),
	}
}
