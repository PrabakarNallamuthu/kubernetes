...
func Deletenetworkingv1alpha1collectionclustercidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apis/networking.k8s.io/v1alpha1/clustercidrs%s", cfg.BaseURL, queryString)
...
func CreateDeletenetworkingv1alpha1collectionclustercidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apis_networking.k8s.io_v1alpha1_clustercidrs",
		mcp.WithDescription("delete collection of ClusterCIDR"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Deletenetworkingv1alpha1collectionclustercidrHandler(cfg),
	}
}
