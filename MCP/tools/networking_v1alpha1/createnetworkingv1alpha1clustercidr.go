...
func Createnetworkingv1alpha1clustercidrHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCreatenetworkingv1alpha1clustercidrTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apis_networking.k8s.io_v1alpha1_clustercidrs",
		mcp.WithDescription("create a ClusterCIDR"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Createnetworkingv1alpha1clustercidrHandler(cfg),
	}
}
