...
func Patchcertificatesv1alpha1clustertrustbundleHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePatchcertificatesv1alpha1clustertrustbundleTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apis_certificates.k8s.io_v1alpha1_clustertrustbundles_name",
		mcp.WithDescription("partially update the specified ClusterTrustBundle"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Patchcertificatesv1alpha1clustertrustbundleHandler(cfg),
	}
}
